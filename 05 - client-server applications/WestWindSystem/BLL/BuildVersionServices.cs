...
{
    //this class needs to be available to the outside world
    public class BuildVersionServices
    {
        ...
        public BuildVersion BuildVersion_Get()
        {
           ...
           * Linq/built-in collection methods has a method that limits the number of rows from a
